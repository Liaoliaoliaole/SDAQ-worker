...
WORK_dir=work
SRC_dir=src
DEP=$(WORK_dir)/Discover_and_autoconf.o $(WORK_dir)/Change_address.o $(WORK_dir)/Measure.o $(WORK_dir)/Logging.o $(WORK_dir)/Dev_info.o $(WORK_dir)/SDAQ_drv.o
...
$(WORK_dir)/Discover_and_autoconf.o: $(SRC_dir)/Discover_and_autoconf.c 
